...
try {
	...
	// $mail->addAddress('teh@apimedia.ru'); // Email получателя
	$mail->addAddress('pdv@apimedia.ru');
}
...
$message = "<h1>Заявка с сайта ландшафт.вседлясада.com</h1>";
if (isset($_POST['name'])) {
...
// Письмо
$mail->isHTML(true);
$mail->Subject = 'Заявка с сайта ландшафт.вседлясада.com'; // Заголовок письма
